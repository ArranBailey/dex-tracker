...
import com.arranbailey.dextracker.model.Serie
import com.arranbailey.dextracker.model.SerieWithSets
...
interface PokeApiService {
    ...
    @GET("series/{id}")
    suspend fun getSerieWithSets(@Path("id") serieId: String): SerieWithSets
}

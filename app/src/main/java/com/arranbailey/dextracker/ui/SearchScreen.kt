...
import com.arranbailey.dextracker.ui.card.CardItem
import com.arranbailey.dextracker.ui.card.CardListScreen
import com.arranbailey.dextracker.ui.card.CustomSearchBar
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SearchScreen(viewModel: CardViewModelOld = viewModel(), onClick: (Card) -> Unit) {
